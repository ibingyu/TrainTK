            ...
            set
            {
                if (_checked != value)
                {
                    ...
                    if (base.Enabled)
                    {
                        if (_checked)
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.radioButton1;
                        }
                        else
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.radioButton0;
                        }
                    }
                    else
                    {
                        if (_checked)
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.radioButton10;
                        }
                        else
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.radioButton00;
                        }
                    }
                    SetCheck(value);
