            ...
            set
            {
                if (_checked != value)
                {
                    ...
                    if (base.Enabled)
                    {
                        if (_checked)
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.checkbox1;
                        }
                        else
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.checkbox0;
                        }
                    }
                    else
                    {
                        if (_checked)
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.checkbox10;
                        }
                        else
                        {
                            panel1.BackgroundImage = Demo111.Properties.Resources.checkbox00;
                        }
                    }
