            ...
            else
            {
                ...
                switch (state)
                {
                    case TipsState.Default:
                        frmTips.pctStat.Image = Demo111.Properties.Resources.alarm;
                        break;
                    case TipsState.Success:
                        frmTips.pctStat.Image = Demo111.Properties.Resources.success;
                        break;
                    case TipsState.Info:
                        frmTips.pctStat.Image = Demo111.Properties.Resources.alarm;
                        break;
                    case TipsState.Warning:
                        frmTips.pctStat.Image = Demo111.Properties.Resources.warning;
                        break;
                    case TipsState.Error:
                        frmTips.pctStat.Image = Demo111.Properties.Resources.error;
                        break;
                    default:
                        frmTips.pctStat.Image = Demo111.Properties.Resources.alarm;
                        break;
