...
namespace TrainTK
{
    public partial class FrmSelectSite2 : Form
    {
        public FrmSelectSite2()
        {
        ...
        public FrmSelectSite2(string btnName)
        {
            btnSite = btnName;
            this.StartPosition = FormStartPosition.CenterScreen;
            InitializeComponent();
        ...
        private void SiteClassify_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                FrmAllTrainNum.depSite = cellContent;
            }
            else if (btnSite== "GetDestSite")
            {
                FrmAllTrainNum.destSite = cellContent;
            }
            {
