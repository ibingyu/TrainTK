...
namespace Demo111
{
    public partial class FrmOrderConf : Form
    {
        public FrmOrderConf()
        {
            InitializeComponent();
        ...
        private void FrmOrderConf_Load(object sender, EventArgs e)
        {
            ...
            this.ticketPrice.Text = order.ticketPrice.ToString() + "元"; 
            #endregion
        ...
        {
            string sql = " SELECT orderID FROM TicketOrder WHERE trainCode='"+trainCode+"' AND userName='"+userName+ "' AND personName='" + personName + "' AND startDate='" + startDate+"'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("订单取消成功！", "提示", MessageBoxButtons.OK);
                this.Close();
            }
        }
        ...
        {
            OrderPay order=new OrderPay(this.order);
            order.ShowDialog();
            this.Close();
        }
    }
