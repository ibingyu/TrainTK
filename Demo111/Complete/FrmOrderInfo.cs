...
namespace Demo111
{
    public partial class FrmOrderInfo : Form
    {
        ...
        public FrmOrderInfo(Order order)
        {
        ...
        private void FrmOrderInfo_Load(object sender, EventArgs e)
        {
            ...
            {
                this.dgvOrderInfo.Rows[0].Cells[9].Value = "未支付";
            }
            else if (order.orderState==1)
            {
                this.dgvOrderInfo.Rows[0].Cells[9].Value = "已支付";
            }
            else if (order.orderState==2)
            {
                this.dgvOrderInfo.Rows[0].Cells[9].Value = "已改签";
            }
            else if (order.orderState == 3)
            {
                this.dgvOrderInfo.Rows[0].Cells[9].Value = "已退票";
            }
        ...
        private void MyPrintDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(order.seatType, new Font(new FontFamily("黑体"), 14), System.Drawing.Brushes.Black, 340, 113);
            e.Graphics.DrawString("限乘当日当次车", new Font(new FontFamily("黑体"), 14), System.Drawing.Brushes.Black, 22, 135);

            #endregion
            #region 下半部分
            e.Graphics.DrawString(order.IDNum, new Font(new FontFamily("黑体"), 18), System.Drawing.Brushes.Black, 20, 170);
            e.Graphics.DrawString(order.PersonName, new Font(new FontFamily("黑体"), 18), System.Drawing.Brushes.Black, 255, 170);
            ...
            e.Graphics.DrawString(order.startSite+"售", new Font(new FontFamily("黑体"), 15), System.Drawing.Brushes.Black, 230, 255);
            #endregion
