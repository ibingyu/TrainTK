...
namespace Demo111
{
    public partial class ChangeOrderPay : Form
    {
        public ChangeOrderPay()
        {
            this.StartPosition=FormStartPosition.CenterScreen;
            InitializeComponent();
        }
        public ChangeOrderPay(Order order,decimal margin)
        {
            this.StartPosition = FormStartPosition.CenterScreen;
            InitializeComponent();
            this.order = order;
        ...
        {
            string sql = "UPDATE TicketOrder SET orderState = 2 WHERE orderID=" + order.orderID;
