...
namespace TrainTK
{
    public partial class FrmSelectSite1 : Form
    {
        public FrmSelectSite1()
        {
        ...
        public FrmSelectSite1(string btnName)
        {
            btnSite = btnName;
            this.StartPosition = FormStartPosition.CenterScreen;
            InitializeComponent();
        ...
        private void SiteClassify_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                FrmChangeTrainNum.depSite = cellContent;
            }
            else if (btnSite== "GetDestSite")
            {
                FrmChangeTrainNum.destSite = cellContent;
            }
