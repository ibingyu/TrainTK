...
namespace Demo111
{
    public partial class FrmChangePurchase : Form
    {
        public FrmChangePurchase()
        {
            this.StartPosition=FormStartPosition.CenterScreen;
            InitializeComponent();
        }
        public FrmChangePurchase(string userName, string trainNum,string date,string personName,Order order)
        {
            this.StartPosition = FormStartPosition.CenterScreen;
            InitializeComponent();
